...
namespace MikuMikuWorld
{
	...
	void ImGuiManager::setBaseTheme(BaseTheme theme)
	{
		...
		else if (theme == BaseTheme::RODEN)
		{
			// RodenUI: Clean, seamless, professional modern theme
			ImGui::StyleColorsDark();
			
			// Modern style adjustments for a cleaner look
			...
			// Professional dark color palette with subtle blue accents
			...
			colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.09f, 0.10f, 0.11f, 0.80f);
			...
			colors[ImGuiCol_ButtonActive] = ImVec4(0.35f, 0.55f, 0.80f, 1.00f);
			...
			colors[ImGuiCol_Separator] = ImVec4(0.20f, 0.22f, 0.25f, 0.60f);
			colors[ImGuiCol_SeparatorHovered] = ImVec4(0.35f, 0.55f, 0.80f, 0.80f);
			colors[ImGuiCol_SeparatorActive] = ImVec4(0.40f, 0.65f, 0.90f, 1.00f);
			colors[ImGuiCol_ResizeGrip] = ImVec4(0.35f, 0.55f, 0.80f, 0.20f);
			colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.35f, 0.55f, 0.80f, 0.60f);
			colors[ImGuiCol_ResizeGripActive] = ImVec4(0.40f, 0.65f, 0.90f, 0.90f);
			colors[ImGuiCol_Tab] = ImVec4(0.14f, 0.15f, 0.17f, 1.00f);
			colors[ImGuiCol_TabHovered] = ImVec4(0.35f, 0.55f, 0.80f, 0.80f);
			colors[ImGuiCol_TabActive] = ImVec4(0.25f, 0.45f, 0.70f, 1.00f);
			...
			colors[ImGuiCol_DockingPreview] = ImVec4(0.35f, 0.55f, 0.80f, 0.70f);
			colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.09f, 0.10f, 0.11f, 1.00f);
			colors[ImGuiCol_PlotLines] = ImVec4(0.50f, 0.70f, 0.90f, 1.00f);
			colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.60f, 0.80f, 1.00f, 1.00f);
			colors[ImGuiCol_PlotHistogram] = ImVec4(0.35f, 0.55f, 0.80f, 1.00f);
			colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.45f, 0.65f, 0.90f, 1.00f);
			colors[ImGuiCol_TableHeaderBg] = ImVec4(0.14f, 0.15f, 0.17f, 1.00f);
			colors[ImGuiCol_TableBorderStrong] = ImVec4(0.20f, 0.22f, 0.25f, 1.00f);
			colors[ImGuiCol_TableBorderLight] = ImVec4(0.18f, 0.20f, 0.22f, 1.00f);
			colors[ImGuiCol_TableRowBg] = ImVec4(0.11f, 0.12f, 0.14f, 1.00f);
			colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.13f, 0.14f, 0.16f, 1.00f);
			colors[ImGuiCol_TextSelectedBg] = ImVec4(0.35f, 0.55f, 0.80f, 0.35f);
			colors[ImGuiCol_DragDropTarget] = ImVec4(0.40f, 0.65f, 0.90f, 0.90f);
